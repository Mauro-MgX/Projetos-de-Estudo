...
def aumentar(num, v, show=False):
    ...
    Args:
        num (float): Valor que vai ser calculado
        v (int): O valor em % que vai ser creditado ao número informado
        show (bool, optional): Variavel que vai mostrar o valor formatado ou não. O padrão é False.
...
def resumo(num, a, d):
    """Função que mostra o Resumo do valor informado.
    
    Args:
        num (float): Valor que vai ser calculado
        a (int): Valor em % que vai ser creditado ao número informado
        d (int): Valor em % que vai ser debitado ao número informado
    """
